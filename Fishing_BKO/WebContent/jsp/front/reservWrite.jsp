...
<body>   
    ...
    <div class="container sub_content">
    	...
    	<div class="row title_box2">
        	<div class="col-md-12"><h3>예약하기</h3></div>
        </div>
        
        <!--Start 테이블 작성페이지-->
    	<div class="row table_wrap table_write">
            <form action="" method="post" name="reservWriteForm" id="reservWriteForm">
                ...
                <input type="hidden" id="day" name="day" data-id="day" value="${bean.day}" />
            	...
            	<table class="table">
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="reservNm" name="reservNm" data-id="reservNm" valid="{label:'예약자명', method:'required'}"></td>
                    </tr>
                    <tr>
                    	<td class="title">연락처</td>
                        <td><input type="text" id="reservHpNo" name="reservHpNo" data-id="reservHpNo" valid="{label:'휴대폰번호', method:'required', type:'tel'}"></td>
                    </tr>
<!--                     <tr> -->
...
<!--                     </tr>                     -->
                    <tr>
                        ...
                        <td><input type="text" id="reservPw" name="reservPw" data-id='reservPw' valid="{label:'비밀번호', method:'required', type:'alphanum'}"><span class="write_info"> * 예약확인을 하실때 필요합니다. </span></td>
                    </tr>
                    <tr>
                    	<td class="title">예약인원</td>
                        <td>
                            대인 : <input style="width:150px;" id="reservAdultsNumber" name="reservAdultsNumber" data-id="reservAdultsNumber" valid="{label:'대인', method:'required', type:'number'}"/>
                            소인 : <input style="width:150px;" id="reservKidsNumber" name="reservKidsNumber" data-id="reservKidsNumber" valid="{label:'소인', type:'number'}"/>
                        </td>
                    </tr>
<!--                     <tr> -->
...
<!--                         <td><input type="text"><span class="write_info">* 스팸방지를 위해 <span style="color:#e55c32">"옐로우보트"</span>중 빠진글자를 채워주세요.</span></td> -->
<!--                     </tr> -->
                  </tbody>
                </table>
            </form>
        ...
        <!--Start 버튼영역-->
        <div class="btn_box">
        	<button type="button" id="regReservationButton" class="btn btn-primary confirm_btn">등록</button>
