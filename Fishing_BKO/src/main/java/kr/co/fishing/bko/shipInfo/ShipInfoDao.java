...
public class ShipInfoDao {
    ...
    public int selectShipInfoListCnt(ShipInfoBean bean) {
        return sqlSession.selectOne("shipInfo.selectShipInfoListCnt", bean);
    }

    public List<ShipInfoBean> selectShipInfoList(ShipInfoBean bean) {
        return sqlSession.selectList("shipInfo.selectShipInfoList", bean);
    }    
}
